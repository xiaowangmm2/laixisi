...
for (var key in entries) {
    entries[key] = ['babel-polyfill', hotMiddlewareScript, entries[key]];
}
var devConfig = {
    devtool: 'source-map',
    entry: entries,
    ...
    resolve: {
        extensions: ['.js'],
        alias: {
            plugn: path.join(rootPath, 'util/plugn'),
            common: path.join(rootPath, 'util/common'),
            image: path.join(rootPath, 'images')
        }
    },
    plugins: [
