/* 名称：本地存储函数
* 功能：LocalStorage兼容ie有问题，改用cookie
*/
...
(function(window, document){
    ...
    iLocalStorage.prototype = {
        setItem: function(key, value,expireslong){
            $.cookie(key,value,{expires:expireslong||1,path:'/'});
        },
        ...
        removeItem: function(key,expireslong){
            $.cookie(key,'',{expires:expireslong||1,path:'/'});
//          $.removeCookie(key);
        }
    }
